                ...
                <div className="grid grid-cols-4 gap-4 p-5">
                    ...
                    <div className="col-span-1 row-span-1 rounded-xl bg-white">
                        <ul className="text-base leading-7 my-3">
                            ...
                            <li class="mb-1">
                                <a href="/" class="flex items-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 ml-5 mr-3" fill="currentColor" viewBox="0 0 24 24">
                            ...
                            <li class="mb-1">
                                <a href="/" class="flex items-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" class="w-5 h-5 ml-5 mr-3">

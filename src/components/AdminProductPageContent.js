                        ...
                        <tbody>
                            {products.map((product) => (
                                <tr key={product.id}>
                                    ...
                                    <td className="py-2 px-4 border-b text-left">{product.brand}</td>
                                    <td className="py-2 px-4 border-b text-left">{product.category}</td>
                                    <td className="py-2 px-4 border-b text-left">{product.price}</td>
                                    <td className="py-2 px-4 border-b text-left">{product.stock}</td>
                                    <td className="py-2 px-4 border-b text-left">{product.updated}</td>

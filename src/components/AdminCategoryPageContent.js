...
const columns = [
    ...
    },
    {
        ...
        cell: (category) => {
            return (
                <Fragment>
                    <button className="bg-yellow-400 rounded-xl p-2 px-3 m-1" onClick={()=>{window.location.href = `/updatecategory/${category.id}`}}>
                    ...
                    <button className="bg-red-400 rounded-xl p-2 px-3 m-1" onClick={()=>{hanleDelete(category.id, category.category_code)}}>
